 ...
 */
            ...
            /**
            *  ActivarLinea bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class ActivarLinea
    ...
    public static class Factory{
        ...
        */
        public static ActivarLinea parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            ActivarLinea object =
                new ActivarLinea();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"activarLinea".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (ActivarLinea)java.sql.xsd.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
