...
/**
 * ObtenerLineasActivasCliente.java
 *
 ...
 */
            ...
            /**
            *  ObtenerLineasActivasCliente bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class ObtenerLineasActivasCliente
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":obtenerLineasActivasCliente",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "obtenerLineasActivasCliente",
    ...
    public static class Factory{
        ...
        */
        public static ObtenerLineasActivasCliente parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            ObtenerLineasActivasCliente object =
                new ObtenerLineasActivasCliente();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"obtenerLineasActivasCliente".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (ObtenerLineasActivasCliente)java.sql.xsd.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://dao.vodafone.pr","activa").equals(reader.getName())){
