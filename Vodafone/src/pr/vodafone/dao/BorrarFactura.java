 ...
 */
            ...
            /**
            *  BorrarFactura bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class BorrarFactura
    ...
    public static class Factory{
        ...
        */
        public static BorrarFactura parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            BorrarFactura object =
                new BorrarFactura();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"borrarFactura".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (BorrarFactura)java.sql.xsd.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
